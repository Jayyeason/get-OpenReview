...
#SBATCH --nodelist=fnlp-4090-59102
#SBATCH --job-name=qwen_vl_vllm_service
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:2
#SBATCH --cpus-per-task=12
#SBATCH --mem-per-cpu=4G
#SBATCH --output=qwen3-vl-vllm-slurm.log
...
# 配置参数
MODEL_PATH="/remote-home1/share/models/Qwen/Qwen3-VL-8B-Instruct"
PORT=8001
HOST="0.0.0.0"
